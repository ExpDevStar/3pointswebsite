                ...
                $('#existingPatients').DataTable({
                    ...
                    columnDefs: [{
                            ...
                            render: function (data, type, row, meta)
                            {
                                ...
                                if (type === 'display')
                                {
                                    data = '<a class="viewPatient" data-medicalrecord="' + encodeURIComponent(data) + '" data-patientname="' + row.firstname + ' ' + row.lastname + '" href="javascript:void(0)">View</a> | <a class="editPatient" data-id="'+row.id+'" data-medicalrecord="' + encodeURIComponent(data) + '" data-patientname="' + row.firstname + ' ' + row.lastname + '" href="javascript:void(0)">Edit</a>| <a class="deletePatient" data-id="'+row.id+'" data-medicalrecord="' + encodeURIComponent(data) + '" data-patientname="' + row.firstname + ' ' + row.lastname + '" href="javascript:void(0)">Delete</a>';
                                }
                                return data;
                            }
                        }],
