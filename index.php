...
<body screen_capture_injected="true">
              ...
              ?>
                    ...
                    <ul class="navbar-nav nav-flex-icons">
                        <li class="nav-item">
                            ...
                            <a href="<?php echo getLink("index.php?logout='1'") ?>" class="nav-link waves-effect"><i
    ...
    <main>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="md-form mt-0">
                                ...
                                <input class="typeahead form-control" type="text" id="suggest"
                                    ria-label="Search for Code" placeholder="Search for Code" value="" name="suggest">
                            ...
                            <div class="row">
                                <div class="offset-md-3 col-sm-5 col-md-7">
                                    <div id="diagnosis-card">
                                        ...
                                        <div id="diagnosis-card">
                                            <input name="clinicalID" readonly class="form-control" type="text"
                                                id="clinicalID" value="">
                                        </div>
                                        <div id="ranking_text"></div>
                                        <h2>Diagnosis</h2>
                                        <input name="DiagnosisID" readonly class="form-control" type="text"
                                            id="DiagnosisID" value="">
                                    </div>
                                    <input type="hidden" class="" aria-label="" placeholder="" name="ranking"
                                        id="ranking" value="" />
                                    <input type="hidden" name="icd_tertiary_ranking" id="icd_tertiary_ranking"
                                        value="" />
                                    <div id="treatment-card">
                                        <h2>Treatment Options</h2>
                                        <input type="text" readonly name="TreatmentID" val="" id="TreatmentID"
                                            class="form-control" />
                                    </div>
                                    <h2>NTA Score</h2>
                                        ...
                                        <div class="card-body card-body-sidebar">
                                            <div class="field_wrapper">
                                                ...
                                                <ul id="ulcart" style="list-style-type:disc;">
                                                    <input name="hospital" id="hospital" type="hidden"
                                                        value="<?php echo $_SESSION['hospital'];?>">
                                                </ul>

                                            </div>
                                            <div class="bottom-buttons">
                                                <span>
                                                    <button class="btn btn-warning align-items-center" id="emptyBtn"><a
                                                            id="btnEmpty">Reset List</a></button>
                                                    <button type="button" data-toggle="modal"
                                                        data-target="#centralModalSuccess" id="completeBtn"
                                                        class="align-items-center btn btn-success complete">Complete</button>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="modal modal-print fade" id="centralModalSuccess" tabindex="-1" role="dialog"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" data-keyboard="false" data-backdrop="static">
                        ...
                        <div class="modal-footers justify-content-center">
                            <button
                                class="printBtn align-items-center btn btn-success complete waves-effect waves-light"><i
  ...
  ?>
    ...
    document.addEventListener('DOMContentLoaded',
        function() {
            $.feedback({
                ajaxURL: siteurl + '/feedback-listener.php',
    ...
    $(document).ready(function() {
        ...
        var source1 = new Bloodhound({
            ...
            remote: {
                url:  siteurl + '/getautocomplete.php?st=%QUERY',
                wildcard: '%QUERY'
            }
        });
        ...
        var source2 = new Bloodhound({
            ...
            queryTokenizer: Bloodhound.tokenizers.whitespace,
            remote: {
                url:  siteurl + '/getautocomplete.php?std=%QUERY',
                wildcard: '%QUERY'
            }
        });
        ...
        function addExtraFields() {
            ...
            $.ajax({
                ...
                icd_desc.forEach(function(icd_desc) {
                    ...
                    if (icd_secondary_ranking == '0' || icd_secondary_ranking == '' ||
                        icd_secondary_ranking == 'undefined' || icd_secondary_ranking == null) {
                        if (icd_ranking != 'N/A') {
            ...
            if (x < maxField) {
                ...
                if ($('#ranking_text:contains("Return to Provider")').length > 0) {
                    ...
                    $('#ulcart').append('<li class="list-unstyled item ui-state-default cartid_' +
                        cartID + '" data-cart-id = "' + cartID + '" data-order="' + cartRank +
                        '"><h5 data-toggle="tooltip" data-placement="top" title="Return to Provider" class="mt-1 mb-1 cart-rank font-weight-bold highlight-red "> ' +
                        cartID + '<span style="display:none" class="icd_tertiary_ranking">(' +
                        icd_tertiary_ranking +
                        ')</span><div class="cartdiag" style="display:none">:' + cartDiag + ',' +
                        cartPrice + '</div></h5><a href="javascript:void(0);" data-id="' + cartID +
                    ...
                    $('#ulcart').append('<li class="list-unstyled item ui-state-default cartid_' +
                        cartID + '" data-cart-id = "' + cartID + '" data-order="' + cartRank +
                        '"><h5 class=" mt-1 mb-1 cart-rank font-weight-bold"> ' + cartID +
                        '<span style="display:none" class="icd_tertiary_ranking">(' +
                        icd_tertiary_ranking +
                        ')</span><div class="cartdiag" style="display:none">:' + cartDiag + ' ' +
                        cartPrice + '</div></h5><a href="javascript:void(0);" data-id="' + cartID +
                        '" class="remove_button"> <i class="fa fa-times" aria-hidden="true"></i></a></li>'
        ...
        $('#completeBtn').on('click', function(e) {
            ...
            $('.modal-body').prepend(
                '<div class="col-12 text-success"><h4 class="patient_name">Patient Name: ' +
                patientName +
                '</h4></div><form id="modal-text" method="post" action="server.php"><ul id="sortable" class="ui-sortable olcart"><input type="hidden" id="hospitalinput" name="hospitalinput" value="' +
                cartHospital +
                '"><input type="hidden" id="medicalrecordinput" name="medicalrecordinput" value="' +
                codes + '"><input type="hidden" name="sort_order" id="sort_order">');
            // clone to modal
            ...
            $.ajax({
                ...
                $.each(questions, function(index, value) {
                    ids.push(value.id);
                    quesHtml +=
                        '<div class="custom-control custom-checkbox float-left"><input type="checkbox" class="form-check-input" id="q' +
                        value.id + '" name="ques[' + value.id +
